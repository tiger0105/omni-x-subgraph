...
export function handleTransfer(event: TransferEvent): void {
  ...
  token.col_url = ''
  if (event.address.toHexString().includes('0x1bB7a33c2db0e5F39221f83845C441318fBE163F')) {
    token.col_url = 'gregs_eth'
  } else if (event.address.toHexString().includes('0x10De6312D9858a907BD2B972E2843aD85EF6fA89')) {
