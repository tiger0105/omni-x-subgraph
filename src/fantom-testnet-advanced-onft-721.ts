...
export function handleTransfer(event: TransferEvent): void {
  ...
  token.col_url = ''
  if (event.address.toHexString().includes('0x5a24731fB8ddB18bF0a6E316B7Bc3Ec08430E2D8'.toLowerCase())) {
    token.col_url = 'gregs_eth'
  } else if (event.address.toHexString().includes('0x4946799f0C9934bE1E8113Ba5b84B855A496e820'.toLowerCase())) {
  ...
  token.chain_id = BigInt.fromString('4002')
